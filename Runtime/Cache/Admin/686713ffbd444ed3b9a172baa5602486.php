    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($list["uid"]); ?>"></td>
                        <td><?php echo ($list["uid"]); ?></td>
                        <!--<td><a href="<?php echo U('edit?uid='.$list['id']);?>"><?php echo ($list["type['name']"]); ?></a></td>-->
                        <td><?php echo ($list["type"]["title"]); ?></td>
                        <td><?php echo (date("y-m-d",$list["type"]["create_time"])); ?></td>
                        <td><?php echo (date("y-m-d",$list["type"]["update_time"])); ?></td>
                        <td>
                            <a title="编辑" href="<?php echo U('edit?uid='.$list['id']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?uid='.$list['id']);?>">删除</a>
                        </td>
