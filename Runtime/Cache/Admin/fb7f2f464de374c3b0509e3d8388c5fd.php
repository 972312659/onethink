...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">报修问题<span class="check-tips">（大概表示出具体情况）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="question" value="<?php echo ((isset($info["question"]) && ($info["question"] !== ""))?($info["question"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">报修人姓名<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">与房主的关系<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="relation" value="<?php echo ((isset($info["relation"]) && ($info["relation"] !== ""))?($info["relation"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
