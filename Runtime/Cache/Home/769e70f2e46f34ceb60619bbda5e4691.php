...
<div class="main">
        ...
        <div class="container-fluid">
            <div class="indexImg row">
                <img src="/Public/Home/wechat/image/index.png" width="100%" />
            </div>
            <div class="serviceList text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="<?php echo U('service',['category_id'=>40]);?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('service',['category_id'=>41]);?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('Fix/index?member='.$member['name']);?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('service',['category_id'=>42]);?>">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo U('service',['category_id'=>43]);?>">
